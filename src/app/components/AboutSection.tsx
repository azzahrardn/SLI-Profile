...
export function AboutSection() {
  ...
  return (
    <BubbleBackground variant="white" density="medium">
      <section
        id="tentang"
        className="py-14 sm:py-10 md:py-12 bg-white relative overflow-hidden"
      >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <p className="text-[#334155] leading-relaxed text-sm sm:text-base">
                {t("about.p1Before")}
                <span className="text-[#0c4a6e]">{t("about.p1Highlight")}</span>
                {t("about.p1After")}
              </p>
              <p className="text-[#334155] leading-relaxed text-sm sm:text-base">
                {t("about.p2Before")}
                <strong>people</strong> dan <strong>technology</strong>
                {t("about.p2After")}
              </p>
